...
function updateCanvas() {
    ...
    sketch = quick_draw_data_set[random_number];
    console.log(sketch);
    document.getElementById("sketchToDraw").innerHTML = sketch;
}
...
document.getElementById('yourSketch').innerHTML = "Your Sketch";
confidence_percentage = Math.round(results[0].confidence*100) + "%";
document.getElementById('confidence').innerHTML = confidence_percentage;
}